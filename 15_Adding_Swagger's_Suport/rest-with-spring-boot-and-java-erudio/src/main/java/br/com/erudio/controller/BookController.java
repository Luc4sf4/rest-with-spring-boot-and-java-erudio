...
@Tag(name = "book", description = "Endpoints for Managind Books")
public class BookController {
	...
	@Operation(summary = "Adds a new Book", description = "Adds a new Book by passing in a JSON. XML or YML", tags = { "book" }, responses = {
			...
			@ApiResponse(description = "Bad Requet", responseCode = "400", content = @Content),
	...
	@Operation(summary = "Find a Books", description = "find a Book", tags = { "book" }, responses = {
			@ApiResponse(description = "Success", responseCode = "200", content = @Content(schema = @Schema(implementation = BookVo.class))
	...
	@PutMapping(consumes = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML,
			MediaType.APPLICATION_YML }, produces = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML,
					MediaType.APPLICATION_YML })
	@Operation(summary = "Updating a new book", description = "Updating a Book", tags = { "book" }, responses = {
	...
	@Operation(summary = "Deletes a Person", description = "Deletes a Person by passing in a JSON, XML or YML", tags = { "book" }, responses = {
			@ApiResponse(description = "No content", responseCode = "204", content = @Content),
			@ApiResponse(description = "Bad Requet", responseCode = "400", content = @Content),
			@ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
			@ApiResponse(description = "Internal Error", responseCode = "500", content = @Content),
